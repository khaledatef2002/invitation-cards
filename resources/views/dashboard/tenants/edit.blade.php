...
<form id="edit-tenant-form" data-id="{{ $tenant->id }}">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-12">
                            ...
                            <div class="tab-pane fade show active" id="company-info" role="tabpanel" aria-labelledby="company-info-tab">
                                ...
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter company name" value="{{ $tenant->name }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="domain" class="form-label">Domain</label>
                                        <input type="text" class="form-control" id="domain" name="domain" placeholder="Enter domain" value="{{ $tenant->domain }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- end tab pane -->
                            ...
                            <div class="tab-pane fade" id="website-info" role="tabpanel" aria-labelledby="website-info-tab">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="auto-image-show">
                                            ...
                                            <label for="logo" class="border rounded-2 profile-photo-edit d-flex justify-content-center align-items-center" style="max-height: 150px;aspect-ratio: 1 / 1;overflow:hidden">
                                                <img src="{{ $tenant->details->logo ? asset('storage/'. $tenant->details->logo) : asset('back/images/users/user-dummy-img.jpg') }}" style="min-width:100%;min-height:100%;" alt="website logo">
                                            </label>
                                        </div>  
                                    </div>
                                    <hr>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter website title" value="{{ $tenant->details->title}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" id="description" name="description" placeholder="Enter website description">{{ $tenant->details->description}}</textarea>
                                    </div>
                                    <hr>
                                    <div>
                                        ...
                                        <div class="auto-image-show">
                                            ...
                                            <label for="background" class="border rounded-2 profile-photo-edit d-flex justify-content-center align-items-center" style="max-height: 200px;aspect-ratio: 1 / 0.45;overflow:hidden">
                                                <img src="{{ $tenant->details->background ? asset('storage/' .$tenant->details->background) : asset('back/images/nft/bg-pattern.png') }}" style="min-width:100%;min-height:100%;" alt="website background">
                                            </label>
                                        </div>  
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex gap-2 col-12 flex-wrap">
                                        <div class="mb-3 flex-fill">
                                            ...
                                            <input type="color" class="form-control" id="button_color" name="button_color" placeholder="Enter submit text color" value="{{ $tenant->details->button_color}}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="button_background" class="form-label">Submit background Color</label>
                                            <input type="color" class="form-control" id="button_background" name="button_background" placeholder="Enter submit background color" value="{{ $tenant->details->button_background}}">
                                        </div>
                                    </div>
                                    <div class="d-flex gap-2 col-12 flex-wrap">
                                        <div class="mb-3 flex-fill">
                                            <label for="border_color" class="form-label">Submit border Color</label>
                                            <input type="color" class="form-control" id="border_color" name="border_color" placeholder="Enter submit border color" value="{{ $tenant->details->border_color}}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="button_border_width" class="form-label">Submit border width</label>
                                            <input type="number" class="form-control" id="border_width" name="border_width" placeholder="Enter submit border width" value="{{ $tenant->details->border_width}}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="button_border-radius" class="form-label">Submit border radius</label>
                                            <input type="number" class="form-control" id="border_radius" name="border_radius" placeholder="Enter submit border radius" value="{{ $tenant->details->border_radius}}">
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div>
                                        ...
                                        <div class="auto-image-show">
                                            ...
                                            <label for="wide" class="border rounded-2 profile-photo-edit d-flex justify-content-center align-items-center" style="max-height: 200px;aspect-ratio: 1 / 0.45;overflow:hidden">
                                                <img src="{{ $tenant->details->wide ? asset('storage/' . $tenant->details->wide) : asset('back/images/nft/bg-pattern.png') }}" style="min-width:100%;min-height:100%;" alt="Wide Card">
                                            </label>
                                        </div>  
                                    </div>
                                    <div class="d-flex gap-2 col-12 flex-wrap">
                                        <div class="mb-3 flex-fill">
                                            ...
                                            <input type="number" min="1" class="form-control" id="x_wide" name="x_wide" placeholder="Enter wide x" value="{{ $tenant->details->x_wide }}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="y_wide" class="form-label">Wide y</label>
                                            <input type="number" min="1" class="form-control" id="y_wide" name="y_wide" placeholder="Enter wide y" value="{{ $tenant->details->y_wide }}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="font_size_wide" class="form-label">Wide font size</label>
                                            <input type="number" min="1" class="form-control" id="font_size_wide" name="font_size_wide" placeholder="Enter wide font size" value="{{ $tenant->details->font_size_wide }}">
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div>
                                        ...
                                        <div class="auto-image-show">
                                            ...
                                            <label for="long" class="border rounded-2 profile-photo-edit d-flex justify-content-center align-items-center" style="max-height: 200px;aspect-ratio: 1 / 2;overflow:hidden">
                                                <img src="{{ $tenant->details->long ? asset('storage/' . $tenant->details->long) : asset('back/images/nft/bg-pattern.png') }}" style="min-width:100%;min-height:100%;" alt="Long Card">
                                            </label>
                                        </div>  
                                    </div>
                                    <div class="d-flex gap-2 col-12 flex-wrap">
                                        <div class="mb-3 flex-fill">
                                            ...
                                            <input type="number" min="1" class="form-control" id="x_long" name="x_long" placeholder="Enter long x" value="{{ $tenant->details->x_long }}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="y_long" class="form-label">Long y</label>
                                            <input type="number" min="1" class="form-control" id="y_long" name="y_long" placeholder="Enter long y" value="{{ $tenant->details->y_long }}">
                                        </div>
                                        <div class="mb-3 flex-fill">
                                            <label for="font_size_long" class="form-label">Long font size</label>
                                            <input type="number" min="1" class="form-control" id="font_size_long" name="font_size_long" placeholder="Enter long font size" value="{{ $tenant->details->font_size_long }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
